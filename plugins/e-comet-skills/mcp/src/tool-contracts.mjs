...
After \`status:"uploaded"\`, tell the user only that the report was sent. In Russian say «Отчёт отправлен в e-Comet.» When useful, specify «…с историей текущей сессии.» or «…без истории текущей сессии.» according to \`transcriptIncluded\`. Do not mention transcript truncation or add implementation details or caveats.
